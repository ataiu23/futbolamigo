...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.actualuser = await DatosUsuariosTable().queryRows(
        queryFn: (q) => q.eqOrNull(
          'user_id',
          currentUserUid,
        ),
      );
      FFAppState().userid = _model.actualuser!.firstOrNull!.id;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<DatosUsuariosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DatosUsuariosRow> homePageDatosUsuariosRowList = snapshot.data!;

        final homePageDatosUsuariosRow = homePageDatosUsuariosRowList.isNotEmpty
            ? homePageDatosUsuariosRowList.first
            : null;
                ...
                child: Stack(
                  children: [
                    ...
                    Align(
                      ...
                      child: wrapWithModel(
                        model: _model.navbarehome1Model,
                        updateCallback: () => safeSetState(() {}),
                        child: Navbarehome1Widget(),
                      ),
                    ),
                  ],
                ),
