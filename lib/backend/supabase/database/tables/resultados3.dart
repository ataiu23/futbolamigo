...
class Resultados3Table extends SupabaseTable<Resultados3Row> {
  @override
  String get tableName => 'RESULTADOS3';

  @override
  Resultados3Row createRow(Map<String, dynamic> data) => Resultados3Row(data);
}

class Resultados3Row extends SupabaseDataRow {
  Resultados3Row(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => Resultados3Table();
