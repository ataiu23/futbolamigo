...
import 'perfilpage_model.dart';
export 'perfilpage_model.dart';
      ...
      body: SafeArea(
        ...
        child: Stack(
          ...
          children: [
                            ...
                            children: [
                              FutureBuilder<List<DatosUsuariosRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<DatosUsuariosRow>
                                      columnDatosUsuariosRowList =
                                      snapshot.data!;

                                  final columnDatosUsuariosRow =
                                      columnDatosUsuariosRowList.isNotEmpty
                                          ? columnDatosUsuariosRowList.first
                                          : null;
                                                ...
                                                onTap: () async {
                                                  ...
                                                  if (selectedMedia != null &&
                                                    ...
                                                    try {
                                                      ...
                                                      _model.isDataUploading_uploadDataN1c =
                                                          false;
                                                    }
                                                    if (selectedUploadedFiles
                                                      ...
                                                      safeSetState(() {
                                                        _model.uploadedLocalFile_uploadDataN1c =
                                                            selectedUploadedFiles
                                                                .first;
                                                      });
                                                    } else {
                                                  ...
                                                  _model.imagen = _model
                                                      .uploadedLocalFile_uploadDataN1c;
                                                  safeSetState(() {});
                                                },
                                                child: Container(
                                                  width: 90.0,
                                                        ...
                                                        if (selectedMedia !=
                                                            ...
                                                            selectedMedia.every((m) =>
                                                                validateFileFormat(
                                                                    ...
                                                                    context))) {
                                                          safeSetState(() =>
                                                              _model.isDataUploading_uploadData0nm =
                                                                  true);
                                                          var selectedUploadedFiles =
                                                              <FFUploadedFile>[];
                                                          ...
                                                          if (selectedUploadedFiles
                                                              ...
                                                              downloadUrls
                                                                  ...
                                                                  selectedMedia
                                                                      .length) {
                                                            safeSetState(() {
                                                              _model.uploadedLocalFile_uploadData0nm =
                                                                  selectedUploadedFiles
                                                                      .first;
                                                              _model.uploadedFileUrl_uploadData0nm =
                                                                  downloadUrls
                                                                      .first;
                                                            });
                                                            showUploadMessage(
                                                        ...
                                                        child: Image.network(
                                                          _model.uploadedFileUrl_uploadData0nm !=
                                                                  ...
                                                                  _model.uploadedFileUrl_uploadData0nm !=
                                                                      ''
                                                              ? _model
                                                                  .uploadedFileUrl_uploadData0nm
                                                              : columnDatosUsuariosRow!
                                                                  .perfilPhoto!,
                                                          fit: BoxFit.fitWidth,
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            columnDatosUsuariosRow?.displayName,
                                            'user',
                                          ),
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await deleteSupabaseFileFromPublicUrl(
                                                  columnDatosUsuariosRow!
                                                      .perfilPhoto!);
                                              await DatosUsuariosTable().update(
                                                data: {
                                                  'Nombre': _model
            ...
            wrapWithModel(
              model: _model.navbaregistroModel,
              updateCallback: () => safeSetState(() {}),
              child: NavbaregistroWidget(),
            ),
          ],
        ),
      ),
