...
import 'golno_amigo_model.dart';
export 'golno_amigo_model.dart';

class GolnoAmigoWidget extends StatefulWidget {
  const GolnoAmigoWidget({
    super.key,
    this.equiponoamigo,
    this.counter,
    this.marcadorlocal,
  ...
  @override
  State<GolnoAmigoWidget> createState() => _GolnoAmigoWidgetState();
}

class _GolnoAmigoWidgetState extends State<GolnoAmigoWidget>
    with TickerProviderStateMixin {
  late GolnoAmigoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GolnoAmigoModel());
