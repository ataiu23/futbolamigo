...
import 'navbarehome1_model.dart';
export 'navbarehome1_model.dart';

class Navbarehome1Widget extends StatefulWidget {
  const Navbarehome1Widget({super.key});

  @override
  State<Navbarehome1Widget> createState() => _Navbarehome1WidgetState();
}

class _Navbarehome1WidgetState extends State<Navbarehome1Widget> {
  late Navbarehome1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Navbarehome1Model());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().notifpend = _model.notificacionespendientes!
